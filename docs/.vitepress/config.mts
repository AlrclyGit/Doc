      ...
      '/music/': [
        {
          text: '叨叨冯乐理课',
          items: [
            { text: '01 音名、五线谱谱号与音高', link: '/music/theory/01.音名、五线谱谱号与音高' },
            { text: '02 小节、力度记号与反复记号', link: '/music/theory/02.小节、力度记号与反复记号' },
            { text: '03 音符、休止符、时值与拍号', link: '/music/theory/03.认识音符、休止符、时值与拍号' },
            { text: '04 特殊拍号、数拍、符点与连线', link: '/music/theory/04.特殊拍号、数拍、符点与连线' },
            { text: '05 理解大小调音阶及调号', link: '/music/theory/05.认识、理解大小调音阶及调号' },
            ...
            { text: '10 作曲和弦篇：五度圈和和弦进程', link: '/music/theory/10.作曲和弦篇：五度圈和和弦进程' },
          ],
        },
      ],
      '/work/': [
