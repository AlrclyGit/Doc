...
<template>
    <div class="A">
        <button
            @click="this.orderBy = 'fraction'"
            :class="{ 'orderBy': orderBy == 'fraction' }"
        >
            分数
        </button>
        <button
            @click="this.orderBy = 'good'"
            :class="{ 'orderBy': orderBy == 'good' }"
        >
            善良值
        </button>
        <button
            @click="this.orderType = 'asc'"
            :class="{ 'orderType': orderType == 'asc' }"
        >
            升序
        </button>
        <button
            @click="this.orderType = 'desc'"
            :class="{ 'orderType': orderType == 'desc' }"
        >
            降序
        </button>
        {{ orderBy }} {{ orderType }}
        <template v-for="lesson in lessonLists" :key="lesson.id">
            <div class="name">
                {{ lesson.name }} - fraction:{{ lesson.fraction }} - good:{{
                lesson.good }}
            </div>
        </template>
    </div>
